...
function LoginComponent() {
    ...
    return (
        <div className="flex items-center justify-center my-28 px-4 sm:px-6 lg:px-8" onSubmit={handleSubmit}>
            <form className="bg-white p-6 sm:p-8 rounded-lg shadow-xl w-full max-w-md">
